...
public class QRCodeGeneratorMedico extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.getExtras() != null) {
            ...
            Log.d("Nome Medico", "" + medico.getNome());
        }

        String userData = medico.getUsername(); // Dati da inserire nel QR code
    ...
    private void saveQRCodeToGallery() {
        ...
        try {
            ...
            Toast.makeText(this, getString(R.string.qr_code_save), Toast.LENGTH_LONG).show();

        } catch (Exception e) {
            Toast.makeText(this, getText(R.string.qr_code_save), Toast.LENGTH_LONG).show();
            e.printStackTrace();
        }
    }
